...
def fixheavyAtoms(pdb_pras, rotamer, mutation, pdb_faspr, keep_ligand, chain_no):
    """
    ...
    for i in os.listdir(os.getcwd()):
        if i == 'out_no_h.pdb' or i == 'out_no_h.cif':
            os.remove(i)

    nchains = checkpdbAtoms(pdb_pras, rotamer, mutation, pdb_faspr, keep_ligand, chain_no)
    ...
    for n in range(len(nchains)):
        ...
        if pdb_pras[-4:] == '.cif':
            # steps over each residue of .cif structure file,
